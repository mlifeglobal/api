module.exports = (Sequelize, Bluebird, Survey, Question) => ({
    ...
    add: {
        schema: [
            'data',
            true,
            [['question', true], ['questionType', true], ['answerType', true], ['surveyID', true, 'integer']
        ...
        async method(ctx) {
            ...
            const quest = await Question.create({ question, questionType, answerType, surveyID, predefindAnswers })
    ...
    update: {
        schema: ['data', true,
            [['questionId', true, 'integer'], ['question'], ['predefindAnswers'],
            ['questionType'], ['answerType']]
        ],
        async method(ctx) {
            const {
                data: { questionId, question, predefindAnswers, questionType, answerType }
            } = ctx.request.body
